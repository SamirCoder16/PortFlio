...
const Projects = ({title,description,subDescription,href,image,tags,setpreview}) => {
  ...
  return (
    <>
    <div className='flex-wrap items-center justify-between py-10 space-y-14 sm:flex sm:space-y-8'
    ...
    >
       <div>
        ...
        <button onClick={()=> setIsHidden(true)} className='flex items-center gap-1 cursor-pointer hover-animation'>
          Read more<img src="assets/arrow-right.svg" alt="right-arrow" className='w-5'/>
        </button>
    </div>
