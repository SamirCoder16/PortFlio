  ...
  return (
    <div className='z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text'>
        ...
        <div className='flex-col hidden md:flex c-space'>
            ...
            animate="visible"
            transition={{ delay:1 }}
            >Hi <span className='text-red-500'>I</span>'m Sam<span className='text-4xl sm:text-4xl inline-block text-red-500 animate-bounce transition-all duration-300'>i</span>r Parvez</motion.h1>
            <div className='flex flex-col items-start'>
               ...
               <motion.div
                ...
                <motion.p 
                 ...
                 className='text-4xl font-medium text-neutral-300'>Web Solution</motion.p>
            </div>
        </div>
        {/* Mobile View */}
        <div className='flex flex-col space-y-6 md:hidden'>
            <motion.p className='text-4xl font-medium'
             ...
             animate="visible"
             transition={{ delay:1 }}
             >Hi,<span className='text-red-500'>I</span>'m Samir</motion.p>
            <div>
