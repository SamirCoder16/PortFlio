...
export const Timeline = ({
  ...
  return (
    <div 
     ...
     <h2 className="text-heading">My <span className="text-red-500">Work</span> Exper<span className="text-red-500 inline-block animate-bounce transition-all duration-150">i</span>ence</h2>
